...
var Student = function (_Person) {
  ...
  function Student(name, location, age, major) {
    _classCallCheck(this, Student);

    var _this = _possibleConstructorReturn(this, (Student.__proto__ || Object.getPrototypeOf(Student)).call(this, name, location, age));
...
var me = new Student('Rossanne Clamp', 'Vancouver', 35, 'Visual Arts');
